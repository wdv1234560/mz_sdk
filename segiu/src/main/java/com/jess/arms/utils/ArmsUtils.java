...
public class ArmsUtils {
    ...
    public static String getString(int stringID) {
        return getResources(AppManager.getAppManager().getApplication()).getString(stringID);
    }
...
//        mToast.setText(string);
//        mToast.show();
        AppManager.getAppManager().showToast(string);
    }
     ...
     * @param string
     */
    public static void makeDialogText(String string) {
        AppManager.getAppManager().showAlertDialog(string);
    }
     ...
     * @param telephone
     */
    public static void startTelephone(String telephone) {
    ...
    public static int getColor( int rid) {
        return getResources(getContext()).getColor(rid);
    }
    ...
    public static AppComponent obtainAppComponentFromContext(Context context) {
        Preconditions.checkNotNull(MzSDK.getAppDelegate(), "%s cannot be null", AppDelegate.class.getName());
//        return ((App) context.getApplicationContext()).getAppComponent();
        return MzSDK.getAppDelegate().getAppComponent();
    }
